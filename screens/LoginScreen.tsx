      ...
      <div className="relative z-10 w-full px-6 py-8 flex flex-col items-center max-w-md mx-auto">
        ...
        <div className="grid grid-cols-3 w-full gap-3 mb-8">
          <button
            ...
            disabled={isLoading}
            className="h-14 bg-input-bg border border-input-border hover:bg-input-border/50 rounded-2xl flex items-center justify-center transition-colors disabled:opacity-50"
