    ...
    return (
        <div className="flex h-screen w-full flex-col items-center justify-center p-8 bg-background-dark text-center overflow-y-auto">
            <div className="relative mb-8">
                <div className="size-32 rounded-full bg-primary/10 border-2 border-primary/20 flex items-center justify-center animate-pulse shadow-[0_0_30px_rgba(19,236,91,0.2)]">
            ...
            <div className="bg-surface-dark/30 backdrop-blur-sm p-6 rounded-[24px] border border-white/5 mb-8 max-w-sm">
                <p className="text-slate-300 text-lg leading-relaxed">
                    Entre em contato com o <span className="text-white font-bold">Presidente</span> ou o <span className="text-white font-bold">Vice-Presidente</span> do seu time para fazer parte da família <span className="text-primary font-black">"{teamDetails.name}"</span> para desfrutar a experiência do AmaPlay.
                </p>
            </div>
